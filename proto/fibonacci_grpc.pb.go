...
func (c *fibonacciClient) Fibonacci(ctx context.Context, in *FibonacciRequest, opts ...grpc.CallOption) (*FibonacciResponse, error) {
	out := new(FibonacciResponse)
	err := c.cc.Invoke(ctx, "/api.Fibonacci/Fibonacci", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFibonacciServer) Fibonacci(context.Context, *FibonacciRequest) (*FibonacciResponse, error) {
...
func _Fibonacci_Fibonacci_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FibonacciRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FibonacciServer).Fibonacci(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Fibonacci/Fibonacci",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServer).Fibonacci(ctx, req.(*FibonacciRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Fibonacci_Fibonacci_Handler,
		},
	},
