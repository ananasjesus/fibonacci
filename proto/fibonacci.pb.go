...
func (x *FibonacciRequest) GetTo() string {
	if x != nil {
		return x.To
	}
	return ""
...
type FibonacciResponse struct {
	...
	From    string  `protobuf:"bytes,1,opt,name=from,proto3" json:"from,omitempty"`
	To      string  `protobuf:"bytes,2,opt,name=to,proto3" json:"to,omitempty"`
	Numbers []int64 `protobuf:"varint,3,rep,packed,name=numbers,proto3" json:"numbers,omitempty"`
}
...
func (x *FibonacciResponse) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *FibonacciResponse) GetTo() string {
	if x != nil {
		return x.To
	}
	return ""
...
func (x *FibonacciResponse) GetNumbers() []int64 {
	if x != nil {
		return x.Numbers
	}
	return nil
...
var file_proto_fibonacci_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x36, 0x0a, 0x10,
	...
	0x52, 0x02, 0x74, 0x6f, 0x22, 0x51, 0x0a, 0x11, 0x46, 0x69, 0x62, 0x6f, 0x6e, 0x61, 0x63, 0x63,
	0x69, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x72, 0x6f,
	...
	0x07, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x03, 0x52, 0x07,
	0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x32, 0x49, 0x0a, 0x09, 0x46, 0x69, 0x62, 0x6f, 0x6e,
	0x61, 0x63, 0x63, 0x69, 0x12, 0x3c, 0x0a, 0x09, 0x46, 0x69, 0x62, 0x6f, 0x6e, 0x61, 0x63, 0x63,
	0x69, 0x12, 0x15, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x46, 0x69, 0x62, 0x6f, 0x6e, 0x61, 0x63, 0x63,
	0x69, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x46,
	...
	0x2f, 0x61, 0x6e, 0x61, 0x6e, 0x61, 0x73, 0x6a, 0x65, 0x73, 0x75, 0x73, 0x2f, 0x66, 0x69, 0x62,
	0x6f, 0x6e, 0x61, 0x63, 0x63, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_fibonacci_proto_depIdxs = []int32{
	0, // 0: api.Fibonacci.Fibonacci:input_type -> api.FibonacciRequest
	1, // 1: api.Fibonacci.Fibonacci:output_type -> api.FibonacciResponse
